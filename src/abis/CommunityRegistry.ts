export const CommunityRegistryAbi = [
  ...
  { inputs: [], name: "WrapperAlreadyDeployed", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "communityId", type: "uint256" },
      { internalType: "string", name: "wrapperName", type: "string" },
      { internalType: "string", name: "wrapperSymbol", type: "string" },
    ],
    name: "deployCommunityWrapper",
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract CommunityWrapperFactory",
        name: "",
        type: "address",
      },
    ],
